...
#+END_SRC
** netcdf-fortran
It is recommended to complete the steps in [[module-setup][Setup module files]] before proceeding (other wise you will need to set some of the env vars used here manually).
* Configure
